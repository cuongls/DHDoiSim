...
{
    public class NhanKhoaPhieuDA
    {
        User user = new User();
        DHDoiSimEntities db = new DHDoiSimEntities();

        //public bool ToggleStatus(int id_sim_kh)
        //{
        //    try
        //    {
        //        var update = (from x in db.Sim_KH where x.ID == id_sim_kh select x).Single();
        //        if (update.StatusOBKH == 1)
        //            update.StatusOBKH = 2;
        //        else
        //            if (update.StatusOBKH == 2)
        //                update.StatusOBKH = 1;
        //        db.SaveChanges();
        //    }
        //    catch (Exception e)
        ...
        //ThaiHN thêm - không dùng
        //public bool AddSim_Phieu(int id_sim_kh)
        //{
        //    var sim_phieu = new Sim_Phieu();
        //    sim_phieu.ID_Sim_KH = id_sim_kh;
        //    try
        //    {
        ...
        //    int CountSubject = db.subjects.Where(a => db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).Count();
        //    ListCount.Add("CountSubject", CountSubject);
        //    //01/11/2020
        //    //ThaiHN thêm 
        //    int CountQuestion = db.questions.Where(a => db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).Count();
        //    //End ThaiHN thêm
        //    ListCount.Add("CountQuestion", CountQuestion);
        //    //01/11/2020
        //    //ThaiHN thêm 
        //    int CountTest = db.tests.Where(a => db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).Count();
        //    //End ThaiHN thêm
        //    ListCount.Add("CountTest", CountTest);
        //    //02/04/2020 ThaiHN thêm CountTest2
        //    //int CountTest2 = db.tests.Count();
        //    //int CountTest2 = (from x in db.tests where x.active == true select x).Count();
        //    int CountTest2 = db.tests.Where(a => a.active == true && db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).Count();
        //    ListCount.Add("CountTest2", CountTest2);
        //    return ListCount;
        //}
        ...
        //    return db.subjects.Where(a => db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).ToList();
        //}
        ...
        //{
        //    return db.units.Where(a => db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).ToList().ToList();
        //}
        ...
        //    //ThaiHN sửa phân quyền theo adminsubject
        //    List<QuestionViewModel> questions = (from x in db.questions.Where(a => db.adminsubjects.Any(b => a.id_subject  == b.id_subject && b.Username == user.USERNAME))
        //                                         join s in db.subjects on x.id_subject equals s.id_subject
        //                                         select new QuestionViewModel { question = x, subject = s }).ToList();
        //    return questions;
        //}
        ...
        //{
        //    //01/10/2020
        //    //ThaiHN thêm where để lọc theo subject
        //    List<TestViewModel> tests = (from x in db.tests.Where(a => a.active == true && db.adminsubjects.Any(b => a.id_subject == b.id_subject && b.Username == user.USERNAME)).ToList()
        //                                 join s in db.subjects on x.id_subject equals s.id_subject
        ...
        //           .Where(p => p.id_subject == id)
        //           .GroupBy(p => p.unit)
        //           .Select(g => new UnitViewModel { Unit = g.Key, UnitName = db.units.FirstOrDefault(x => x.id_unit == g.Key).unitname,Total = g.Count() }).ToList();
        //    return tests;
        //}
        ...
        ////02/2020
        ////New function
        ////Add to quests_of_unit
        //public bool AddQuestsToUnit(int test_code, int id_unit, int numbers_of_quests)
        //{
        //    var quest_of_unit = new quests_of_unit();
        //    quest_of_unit.test_code = test_code;
        //    quest_of_unit.id_unit = id_unit;
        //    quest_of_unit.numbers_of_quests = numbers_of_quests;
        //    try
        //    {
        //        db.quests_of_unit.Add(quest_of_unit);
        //        db.SaveChanges();
        //    }
        //    catch (Exception e)
        //    {
