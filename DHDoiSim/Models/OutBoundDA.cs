    ...
    public class OutBoundDA
    {
        ...
        public bool ToggleStatus(int id_sim_kh)
        {
            try
            {
                ...
                if (update.ID_StatusOBKH == 1)
                {
                    update.ID_StatusOBKH = 2;
                    update.NguoiGoi = user.USERNAME;
                }
                else
                    if (update.ID_StatusOBKH == 2)
                    {
                        update.ID_StatusOBKH = 1;
                        update.NguoiGoi = null;
                    }
                db.SaveChanges();
            }
            catch (Exception e)
